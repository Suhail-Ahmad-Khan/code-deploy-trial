...
sudo su -c "mkdir /home/ubuntu/fundooNotes"
sudo su -c "unzip -o /home/ubuntu/fundooNotes.zip -d /home/ubuntu/fundooNotes"
sudo su -c "cd /home/ubuntu/fundooNotes/target;
